...
$limit = 3;
$sql = "SELECT * FROM lostproduct JOIN user ON lostproduct.author=user.user_id ORDER BY lproductid DESC LIMIT {$limit}";
...
if (isset($result) > 0) {
    while ($row = mysqli_fetch_assoc($result)) {
        ...
        <div class="recent-post d-flex">
            <a class="post-img" href="readmore.php?id=<?php echo $row['lproductid'] ?>">
            ...
            <div class="post-content" style="padding-left: 10px;">
                ...
                <div style="padding-top: 10px !important;">
                    <button class="btn btn-primary"><a style="color: #fff;padding: 0 !important;" class="read-more"
                            href="readmore.php?id=<?php echo $row['lproductid'] ?>">READ MORE</a></button>
                </div>
            </div>
        </div>
        <?php
