...
$offset = ($page - 1) * $limit;
$sql = "SELECT * FROM lostproduct WHERE objectname LIKE '%{$search_terms}%' OR description LIKE'%{$search_terms}%' ORDER BY lproductid DESC LIMIT {$offset},{$limit}";
                                        ...
                                        <div class="inner-content clearfix">
                                            ...
                                            <div class="post-information">
                                                <span>
                                                    ...
                                                    <a href='author.php' style="color: #666;">Admin</a>
                                                </span>
                                            ...
                                            <button class="btn btn-primary"><a class=''
                                                    href="readmore.php?id=<?php echo $row['lproductid'] ?>"
...
?>
                            <div class="my-4">
                                <nav aria-label="Page navigation example">
                                    <?php
$sql2 = "SELECT * FROM lostproduct WHERE objectname LIKE '%{$search_terms}%' OR description LIKE '%{$search_terms}%'";
...
if (isset($result2) > 0) {
    ...
    for ($i = 1; $i <= $total_page; $i++) {
        echo '<li class="page-item"><a class="page-link" href="search.php?search=' . $search_terms . '&page=' . $i . '">' . $i . '</a></li>';
