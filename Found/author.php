...
if (isset($_GET['aid'])) {
    $author = $_GET['aid'];
    $sql2 = "SELECT * FROM foundproduct JOIN user ON foundproduct.author=user.user_id WHERE foundproduct.author={$author}";
...
$sql = "SELECT * FROM foundproduct JOIN user ON foundproduct.author=user.user_id WHERE foundproduct.author={$author} ORDER BY foundproduct.fproductid DESC LIMIT {$offset},{$limit}";
...
$sql3 = "SELECT * FROM foundproduct WHERE author={$author}";
